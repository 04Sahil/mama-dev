...
(function () {
    ...
    btn.onclick = async () => {
        ...
        try {
            ...
            `;
            chatCard.innerHTML = `
                <h4 style="margin:0 0 8px 0;font-size:15px;">💬 Ask About This Course</h4>
                <div style="display:flex;gap:8px;align-items:flex-end;">
                    <textarea class="udemy-input" placeholder="Type your question here..." rows="2" style="resize:none;flex:1;min-height:60px;"></textarea>
                    <button class="udemy-tool-btn secondary" id="askBtn" style="height:60px;margin:0;">Ask</button>
                </div>
    ...
    // Add this after all your panel content and logic, before the end of your main IIFE:
    panel.addEventListener('click', function (e) {
        ...
        panel.scrollTop = 0; // Optional: scroll to top
    });
})();
