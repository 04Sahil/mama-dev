...
**************************************************************/
    ...
    btn.onclick = async () => {
        ...
        try {
            ...
            modBtn.onclick = () => {
                // Clear modulesArea and remove any previous flexRow
                ...
                dqBtn.onclick = async () => {
                    ...
                    const renderQuestion = (qBlock) => {
                        ...
                        if (!dqOver) {
                            ...
                            dqOver.innerHTML = `
                        <button style="position:absolute;top:8px;right:12px;font-size:16px;border:none;background:#f44336; color:white;padding:4px 10px;border-radius:4px;cursor:pointer;" onclick="this.parentElement.remove()">✖</button>
                        ...
                        <button id="dqSubmit" type="button" style="margin-top:15px;padding:8px 16px;background:#4caf50;color:white; border:none;border-radius:5px;cursor:pointer;">Submit</button>
...
Use real aptitude style, medium difficulty.
        `.trim();
            ...
            if (!panel.contains(closeBtn)) panel.appendChild(closeBtn);
            console.error(err);
        }
    };
