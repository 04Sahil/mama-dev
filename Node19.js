...
(function () {
    ...
    btn.onclick = async () => {
        ...
        try {
            ...
            const chatToggle = chatCard.querySelector('#chatToggle');
            const chatContent = chatCard.querySelector('#chatContent');
            chatToggle.addEventListener('click', () => {
                const isVisible = chatContent.style.display !== 'none';
                chatContent.style.display = isVisible ? 'none' : 'block';
                chatToggle.innerHTML = isVisible ? '💬 Ask About This Course ▶' : '💬 Ask About This Course ▼';
            });
            
            // Append to udemyAnalysisPanel
            ...
            // Toggle for Modules Section
            const modToggle = document.createElement('h4');
            modToggle.innerHTML = '📂 Course Modules ▼';
            modToggle.style.cssText = 'margin-top:0; cursor:pointer;';
            modToggle.addEventListener('click', () => {
                const isVisible = modulesList.style.display !== 'none';
                modulesList.style.display = isVisible ? 'none' : 'block';
                modToggle.innerHTML = isVisible ? '📂 Course Modules ▶' : '📂 Course Modules ▼';
            });
            modCard.insertBefore(modToggle, modCard.firstChild);
            ...
            // Toggle for Project Evaluation Section
            const evalToggle = document.createElement('h4');
            evalToggle.innerHTML = '🧑‍💻 Project Evaluation ▼';
            evalToggle.style.cssText = 'margin-top:0; cursor:pointer;';
            evalToggle.addEventListener('click', () => {
                const isVisible = ghInput.style.display !== 'none';
                ghInput.style.display = isVisible ? 'none' : 'block';
                evalBtn.style.display = isVisible ? 'none' : 'block';
                evalResult.style.display = isVisible ? 'none' : 'block';
                evalToggle.innerHTML = isVisible ? '🧑‍💻 Project Evaluation ▶' : '🧑‍💻 Project Evaluation ▼';
            });
            evalCard.insertBefore(evalToggle, evalCard.firstChild);
            ghInput.style.display = 'block';
