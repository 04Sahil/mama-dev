...
(function () {
    ...
    btn.onclick = async () => {
        ...
        try {
            ...
            // 2. Chat Interface (fixed at footer of udemyAnalysisPanel)
            ...
            // Append to udemyAnalysisPanel and adjust panel padding-bottom
            panel.appendChild(chatCard);
            panel.style.paddingBottom = '110px'; // Make space for chatCard
