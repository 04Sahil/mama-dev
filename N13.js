...
/* --- PUZZLE GENERATOR ------------------------------------ */
    ...
    try {
        ...
        const cluePrompt = `You are a crossword puzzle clue generator. Given a list of Udemy course modules, generate short clues (1-5 words each) that hint at each module without directly repeating its name.

        For each module, reply in this **exact format**:
        MODULE_NAME: clue

        Guidelines:
        • Do NOT repeat the module name in the clue.
        • The clue must help a person guess the module.
        • Use only one line per module.
        • Keep clues short and sharp.
