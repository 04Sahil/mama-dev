...
(function () {
    ...
    btn.onclick = async () => {
        ...
        try {
            ...
            // 2. Chat Interface (removed "Suggest Projects" button)
            ...
            chatCard.innerHTML = `
                ...
                <button class="udemy-tool-btn secondary" id="askBtn" style="width:100%;">Ask Question</button>
            ...
            memeBtn.onclick = async () => {
                ...
                memeResult.innerHTML = `
                    <div style="display:flex;align-items:center;padding:12px;background:#fff3e0;border-radius:4px;">
                        ...
                        <span style="margin-left:8px;">Creating your meme...</span>
                    </div>
                `;
                ...
                try {
                    ...
                    if (!memeJson.success) {
                        memeResult.innerHTML = `<div style="color:${styles.dangerColor};padding:8px;background:#ffebee;border-radius:4px;">❌ Imgflip error: ${memeJson.error_message}</div>`;
                        return;
                    }
            ...
            panel.innerHTML = `
                <div style="color:${styles.dangerColor};padding:20px;">
                    ❌ Failed to analyze course. Please try again.
                </div>
            `;
            console.error(err);
        }
