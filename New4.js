        ...
        try {
            ...
            modBtn.onclick = () => {
                ...
                projBtn.style.cssText =
                    'margin-top:10px;padding:8px 18px;border:none;background:#28a745;color:white;border-radius:8px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.08);font-size:15px;transition:background 0.2s;';
                projBtn.onmouseenter = () => projBtn.style.background = '#218838';
                projBtn.onmouseleave = () => projBtn.style.background = '#28a745';
                ...
                quizBtn.style.cssText =
                    'margin-top:10px;margin-left:8px;padding:8px 18px;border:none;background:#ffc107;color:#222;border-radius:8px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.08);font-size:15px;transition:background 0.2s;';
                quizBtn.onmouseenter = () => quizBtn.style.background = '#ffb300';
                quizBtn.onmouseleave = () => quizBtn.style.background = '#ffc107';
                ...
                ghInput.style.cssText = 'margin-top:12px;width:100%;padding:8px 10px;border:1.5px solid #bdbdbd;border-radius:7px;font-size:15px;';
                modulesArea.appendChild(ghInput);

                const evalBtn = document.createElement('button');
                evalBtn.textContent = '🧠 Evaluate Project';
                evalBtn.style.cssText =
                    'margin-top:10px;padding:8px 18px;border:none;background:#9c27b0;color:white;border-radius:8px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.08);font-size:15px;transition:background 0.2s;';
                evalBtn.onmouseenter = () => evalBtn.style.background = '#6d1b7b';
                evalBtn.onmouseleave = () => evalBtn.style.background = '#9c27b0';
                ...
                memeBtn.style.cssText = 'margin-top:10px;margin-left:8px;padding:8px 18px;border:none;background:#ff5722;color:white;border-radius:8px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.08);font-size:15px;transition:background 0.2s;';
                memeBtn.onmouseenter = () => memeBtn.style.background = '#d84315';
                memeBtn.onmouseleave = () => memeBtn.style.background = '#ff5722';
