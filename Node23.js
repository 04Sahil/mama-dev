...
(function () {
    ...
    // ▸ TEST CONTROLS (Remove after testing)
    const testPanel = document.createElement('div');
    testPanel.style.cssText = 'position:fixed;top:20px;right:20px;background:#fff;padding:10px;z-index:99999;border:1px solid #ccc;';
    testPanel.innerHTML = `
      <h4 style="margin:0 0 10px 0">XP System Test</h4>
      <button onclick="addXP(50)">+50 XP</button>
      <button onclick="addXP(100)">+100 XP</button>
      <button onclick="addXP(250)">+250 XP</button>
      <button onclick="localStorage.removeItem('udemyXPData_xp');location.reload()">Reset</button>
    `;
